...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default="/mnt/data/PROJECTS/Face_data-application/src/checkpoints/LightCNN_29Layers_V2_checkpoint.pth.tar", 
    ...
    parser.add_argument("--yolo", default="/mnt/data/PROJECTS/Face_data-application/src/yolo/weights/yolo11n-face.pt", 
